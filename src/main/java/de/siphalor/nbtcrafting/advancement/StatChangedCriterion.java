...
public class StatChangedCriterion extends AbstractCriterion<StatChangedCriterion.Conditions<?>> {
	...
	@Override
	protected Conditions<?> conditionsFromJson(JsonObject obj, EntityConditions playerPredicate, AdvancementEntityPredicateDeserializer predicateDeserializer) {
	...
	static class Conditions<T> extends AbstractCriterionConditions {
		...
		public Conditions(StatType<T> statType, T object, NumberRange.IntRange intRange, EntityConditions playerPredicate) {
